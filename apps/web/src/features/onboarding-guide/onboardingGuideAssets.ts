...
const ONBOARDING_IMAGE_PATHS: Record<OnboardingImageMode, Partial<Record<OnboardingGuideSlideKey, OnboardingImageDescriptor>>> = {
  light: {
    ...
    globalWelcome: { src: '/images/guides/light/plans-welcome-light.webp', width: 960, height: 960 },
    globalWorlds: { src: '/images/guides/light/plans-discover-light.webp', width: 960, height: 960 },
    globalAccountHub: { src: '/onboarding/light/account-guide-light.webp', width: 960, height: 960 },
  ...
  dark: {
    ...
    globalWelcome: { src: '/images/guides/dark/plans-welcome-dark.webp', width: 960, height: 960 },
    globalWorlds: { src: '/images/guides/dark/plans-discover-dark.webp', width: 960, height: 960 },
    globalAccountHub: { src: '/onboarding/dark/account-guide-dark.webp', width: 960, height: 960 },

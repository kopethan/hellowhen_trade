...
type NewProposalNeedFullPageProps = {
...
function chooseNeedHref(tradeId: string, params: { proposalNeedId?: string; proposalOfferId?: string }) {
  ...
  return `/trades/${tradeId}/propose/choose-need/new${query ? `?${query}` : ''}`;
}

export default async function NewProposalNeedFullPage({ params, searchParams }: NewProposalNeedFullPageProps) {

...
type NewProposalOfferFullPageProps = {
...
function chooseOfferHref(tradeId: string, params: { proposalNeedId?: string; proposalOfferId?: string }) {
  ...
  return `/trades/${tradeId}/propose/choose-offer/new${query ? `?${query}` : ''}`;
}

export default async function NewProposalOfferFullPage({ params, searchParams }: NewProposalOfferFullPageProps) {

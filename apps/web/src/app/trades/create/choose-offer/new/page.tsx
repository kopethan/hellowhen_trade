...
function chooseOfferHref(params: { needId?: string; offerId?: string; postType?: string; returnTo?: string; idea?: string; expiryDays?: string }) {
    ...
    <InventoryCreateWizardClient
      ...
      afterCreateRedirect={{
        ...
        preservedParams: {
          ...
          needId: resolvedSearchParams.postType === 'open_offer' ? undefined : resolvedSearchParams.needId,

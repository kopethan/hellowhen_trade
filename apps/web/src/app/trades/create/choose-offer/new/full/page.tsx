...
type NewOfferFromTradeFullPageProps = {
...
function chooseOfferHref(params: { needId?: string; offerId?: string; postType?: string; returnTo?: string }) {
  ...
  return `/trades/create/choose-offer/new${query ? `?${query}` : ''}`;
}

export default async function NewOfferFromTradeFullPage({ searchParams }: NewOfferFromTradeFullPageProps) {

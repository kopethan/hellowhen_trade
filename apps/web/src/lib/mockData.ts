...
export const mockTrades: TradeDto[] = [
...

  {
    ...
    updatedAt: now,
    expiresAt: inSixDays,
    owner: { id: 'demo-user-4', profile: { displayName: 'Yara', handle: 'yara', avatarUrl: null } },
    need: {
      id: 'demo-open-need-1',
      ownerId: 'demo-user-4',
  ...
  {
    id: 'demo-trade-open-offer-1',
    ownerId: 'demo-user-5',
    title: 'Open Offer: UI polish review',
    description: 'I can review one app screen and send quick UI polish notes. Tell me what you need in return or what screen needs review.',
    creditAmount: 0,
    amountCents: 0,
    currency: 'eur',
    postType: 'open_offer',
    ...
    updatedAt: now,
    expiresAt: null,
    owner: { id: 'demo-user-5', profile: { displayName: 'Leo', handle: 'leo', avatarUrl: null } },
    need: null,
    offer: {
      id: 'demo-open-offer-1',
      ownerId: 'demo-user-5',
      title: 'UI polish review',
      description: 'I can review a screen, point out layout issues, and suggest copy and spacing improvements.',
      defaultLanguage: 'en',
      itemType: 'service',
      category: 'Design',
      ...
      mode: 'remote',
      locationLabel: 'Remote',
      includes: ['One screen review', 'Prioritized notes'],
      tags: ['ui', 'design'],
      status: 'active',
      createdAt: now,
      updatedAt: now,

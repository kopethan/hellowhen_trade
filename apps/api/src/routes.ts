...
import { planWeatherRoutes } from './modules/plans/planWeather.routes.js';
...
routes.use('/places', requirePlansEnabled('Place Library'), placesRoutes);
routes.use('/plans', requirePlansEnabled(), planWeatherRoutes, plansRoutes);

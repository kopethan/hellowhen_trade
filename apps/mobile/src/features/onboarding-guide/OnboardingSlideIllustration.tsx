...
const ONBOARDING_IMAGE_ASSETS: Record<OnboardingImageMode, Partial<Record<OnboardingGuideSlideKey, ImageSourcePropType>>> = {
  light: {
    ...
    globalWelcome: require('../../../assets/guides/light/plans-welcome-light.png'),
    globalWorlds: require('../../../assets/guides/light/plans-discover-light.png'),
    globalAccountHub: require('../../../assets/onboarding/light/account-guide-light.jpg'),
  ...
  dark: {
    ...
    globalWelcome: require('../../../assets/guides/dark/plans-welcome-dark.png'),
    globalWorlds: require('../../../assets/guides/dark/plans-discover-dark.png'),
    globalAccountHub: require('../../../assets/onboarding/dark/account-guide-dark.jpg'),

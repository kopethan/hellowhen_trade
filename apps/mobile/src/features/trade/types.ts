import type { MediaAssetDto, NeedDto, OfferDto, ProposalMessageDto, PublicMediaAccessDto, TradeDto, TradeProposalDto } from '@hellowhen/contracts';
...
export type NeedItem = NeedDto & { media?: MediaAssetDto[]; mediaAccess?: PublicMediaAccessDto };
export type OfferItem = OfferDto & { media?: MediaAssetDto[]; mediaAccess?: PublicMediaAccessDto };
export type TradeDeckItem = TradeDto & { owner?: TradeOwnerPreview | null; provider?: TradeOwnerPreview | null; need?: NeedItem | null; offer?: OfferItem | null; payment?: TradePaymentPreview | null; escrow?: TradeEscrowPreview | null; media?: MediaAssetDto[]; mediaAccess?: PublicMediaAccessDto; amountCents?: number; currency?: string };

...
export const betaFeatures = {
  ...
  plansEnabled: enabled(process.env.EXPO_PUBLIC_PLANS_ENABLED),
  plansVisible: enabled(process.env.EXPO_PUBLIC_PLANS_ENABLED) && enabled(process.env.EXPO_PUBLIC_PLANS_VISIBLE),
} as const;
